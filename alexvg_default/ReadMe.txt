========================================================================
    WIN32 응용 프로그램 : alexvg_default 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 이 alexvg_default 응용 프로그램을 만들었습니다.  

이 파일에는 alexvg_default 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.


alexvg_default.vcproj
...
alexvg_default.ico
    ...
    이 아이콘은
    기본 리소스 파일인 alexvg_default.rc에 의해 포함됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일인 alexvg_default.pch와
